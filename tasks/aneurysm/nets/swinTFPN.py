...
class WindowAttention3D(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        #print('3333',self.dim, self.num_heads, head_dim)
...
class PatchEmbed3D(nn.Module):
    ...
    def forward(self, x):
        ...
        # padding
        _, _, D, H, W = x.size()
        #print('_, _, D, H, W',_, _, D, H, W) #1 1 128 128 128
...
class SwinTransformer3DFPN(nn.Module):
    ...
    def __init__(self,
                 pretrained=None,
                 pretrained2d=True,
                 patch_size=(2,4,4), # # (256,256,256) #(2,4,4)
                 in_chans=1, #3
                 embed_dim=48, # 12  48 96 (24 [2, 2, 6] [3, 6, 12])
                 depths=[2, 2, 6, 2], #[2, 2, 6, 2], 
                 num_heads=[3, 6, 12, 24], #[1, 2, 4, 8],  #[3, 6, 12, 24]
