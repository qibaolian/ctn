...
class VesselPatchSampler(object):
    ...
    def __init__(self, subject, sample_num, stage='train', only_prior=False):
...
class VesselSubjectDS(BaseDataset):
    ...
    def train_init(self):
        ...
        self.only_prior = self.para_dict['only_prior']
